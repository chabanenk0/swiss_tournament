 ...
 */
class Version20180218152934 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE round_result (id INT AUTO_INCREMENT NOT NULL, tournament_id INT DEFAULT NULL, round_id INT DEFAULT NULL, white_participant_id INT DEFAULT NULL, first_move_id INT DEFAULT NULL, begin_timestamp BIGINT NOT NULL, end_timestamp BIGINT NOT NULL, black_time_spent_in_seconds BIGINT NOT NULL, white_time_spent_in_seconds BIGINT NOT NULL, INDEX IDX_D7DDF8BF33D1A3E7 (tournament_id), INDEX IDX_D7DDF8BFA6005CA0 (round_id), INDEX IDX_D7DDF8BF9EA4E67E (white_participant_id), INDEX IDX_D7DDF8BF7E492D54 (first_move_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, player_id INT DEFAULT NULL, participant_order INT NOT NULL, INDEX IDX_D79F6B1199E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE round_result ADD CONSTRAINT FK_D7DDF8BF9EA4E67E FOREIGN KEY (white_participant_id) REFERENCES participant (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE round_result DROP FOREIGN KEY FK_D7DDF8BF9EA4E67E');
        $this->addSql('ALTER TABLE participant DROP FOREIGN KEY FK_D79F6B1199E6F5DF');
